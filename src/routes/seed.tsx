...
const buildLogs = [
  { body: "just got the drone navigation working! it can avoid trees now 🌳", image_url: "/projects/Drone.webp" },
  { body: "added the seed bombing mechanism - test drop successful! 🚀", image_url: "/projects/Payload.webp" },
  { body: "YOLO model is detecting open areas for planting with 94% accuracy 🤖", image_url: null },
  { body: "blindsight prototype can now detect stairs and curbs! 🦯", image_url: "/projects/Blindsight.webp" },
  { body: "vibecode AI assistant just wrote 200 lines of working code for me 🎉", image_url: "/projects/ai-talkbot.webp" }
];
...
function SeedPage() {
  ...
  return (
    <div className="min-h-screen bg-background p-8">
      <div className="max-w-md mx-auto brutal-card p-8">
        <h1 className="font-display font-black text-3xl mb-4">Seed Data</h1>
        <p className="text-muted-foreground mb-6">This will delete all existing data and populate your projects.</p>
        {status && <div className="mb-4 p-4 bg-card border-2 border-white/20 font-mono">{status}</div>}
        <button
          onClick={seedData}
          disabled={loading}
