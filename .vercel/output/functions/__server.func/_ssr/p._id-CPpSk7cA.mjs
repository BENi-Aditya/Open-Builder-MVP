...
import { b as Route, u as useAuth, A as Avatar } from "./router-BEE4HkqR.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { u as uploadMedia } from "./upload-DTUcDnx0.mjs";
import { b as Heart, a as Bookmark, E as ExternalLink, G as Github, Z as Zap, d as MessageCircle, f as Send, T as Trash2 } from "../_libs/lucide-react.mjs";
...
function ProjectPage() {
  ...
  const load = async () => {
    ...
    const [{
      ...
      data: lg
    }] = await Promise.all([supabase.from("comments").select("id, body, created_at, user_id, user:profiles!comments_user_id_fkey(id, username, display_name, avatar_url)").eq("project_id", id).order("created_at", {
      ascending: false
    ...
    if (user) {
      const [{
        ...
        data: sv
      }] = await Promise.all([supabase.from("likes").select("user_id").eq("user_id", user.id).eq("project_id", id).maybeSingle(), supabase.from("saves").select("user_id").eq("user_id", user.id).eq("project_id", id).maybeSingle()]);
      setLiked(!!lk);
      setSaved(!!sv);
    }
    setLoading(false);
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-3 gap-6 mt-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2 space-y-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "brutal-card-flat p-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: comments.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 group", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-2", children: [
                  ...
                  (user?.id === c.user_id || isOwner) && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => deleteComment(c.id), className: "ml-auto opacity-0 group-hover:opacity-100 text-muted-foreground hover:text-destructive", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "w-3 h-3" }) })
                ] }),
