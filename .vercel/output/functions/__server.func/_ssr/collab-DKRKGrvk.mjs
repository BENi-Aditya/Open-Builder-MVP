...
import { C as CollabCard } from "./CollabCard-BG2p3Tdq.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { e as Plus, X } from "../_libs/lucide-react.mjs";
...
function CollabPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto p-4 md:p-8 pb-24", children: [
    ...
    posts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-center py-12", children: "No collab posts yet. Be first." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 gap-4", children: posts.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(CollabCard, { post: p, onApply: user && p.user.id !== user.id ? () => setApplyTo(p) : void 0 }, p.id)) }),
